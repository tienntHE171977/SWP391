<%-- 
    Document   : orderfail
    Created on : Jul 10, 2024, 10:58:51 AM
    Author     : pc
--%>
        ...
        <div class="w-50 m-auto">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><span text="${orderId}">${orderId}</span></td>
                </tr>
                <tr>
                    <td>Tổng tiền:</td>
                    <td><span text="${totalPrice}">${totalPrice}</span></td>
                </tr>
                <tr>
                    <td>Thời gian thanh toán:</td>
                    <td><span text="${paymentTime}">${paymentTime}</span></td>
                </tr>
                <tr>
                    <td>Mã giao dịch:</td>
                    <td><span text="${transactionId}">${transactionId}</span></td>
                </tr>
                </tbody>
            </table>
            <a href="${pageContext.request.contextPath}/homePage" class="btn btn-primary">Về trang chủ</a>
        </div>
    </div>
</div>
<!-- end body -->
