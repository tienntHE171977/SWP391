                                ...
                                <c:forEach items="${cart.items}" var="item">
                                    <tr>
                                        ...
                                        <td class="product-des" data-title="Description">
                                            ...
                                            <!-- <p class="product-des">${item.product.productDescription}</p> -->
                                        </td>
                                        <td class="price" data-title="Price"><span>${item.product.originalPrice} </span></td>
                                        <td class="align-middle">
                                            <a href="process?num=-1&id=${item.product.productId}" onclick="decreaseQuantity(this)">
                                                <button class="btnSub btn-lg">-</button>
                                            </a> 
                                            <strong class="quantity">${item.quantity}</strong>
                                            <a href="process?num=1&id=${item.product.productId}" onclick="increaseQuantity(this)">
                                                <button class="btnAdd btn-lg">+</button>
                                            </a>
                                        </td>
                                        <td class="total-amount" data-title="Total"><span>${item.product.originalPrice * item.quantity}</span></td>
                                        ...
                                        <ul class="list-unstyled mb-4">
                                            ...
                                            <c:forEach items="${cart.items}" var="item">                             
                                                ...
                                                <li class="d-flex justify-content-between py-3 border-bottom">
                                                    <strong class="text-muted">${item.product.productName} * ${item.quantity}</strong>
                            ...
                            <div class="single-footer social">
                                ...
                                <div class="contact">
                                    <ul>
                                        ...
                                        <li>Hòa Lạc- Thạch Thất</li>
                                        <li>thachthatstore@edu.vn</li>
                                        <li>+84 7777 77078</li>
                                    </ul>
                                </div>
                                <!-- End Single Widget -->
