<%-- 
    Document   : index
    Created on : Jun 19, 2024, 1:41:41 AM
    Author     : FPT
--%>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-12">
                            ...
                            <div class="top-left">
                                <ul class="list-main">
                                    <li><i class="ti-headphone-alt"></i> +84 7777 77078</li>
                                    <li><i class="ti-email"></i> thachthatstore@edu.vn</li>
                                </ul>
                            </div>
                            <!--/ End Top Left -->
                        </div>
